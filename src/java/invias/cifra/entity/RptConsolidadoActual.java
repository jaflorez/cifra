 ...
 */
@Entity
@Table(name = "rpt_consolidado_actual")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "RptConsolidadoActual.findAll", query = "SELECT r FROM RptConsolidadoActual r")
    , @NamedQuery(name = "RptConsolidadoActual.findByIdentificador", query = "SELECT r FROM RptConsolidadoActual r WHERE r.identificador = :identificador")
    , @NamedQuery(name = "RptConsolidadoActual.findByFkContrato", query = "SELECT r FROM RptConsolidadoActual r WHERE r.fkContrato = :fkContrato")
    , @NamedQuery(name = "RptConsolidadoActual.findByFkReporte", query = "SELECT r FROM RptConsolidadoActual r WHERE r.fkReporte = :fkReporte")
    , @NamedQuery(name = "RptConsolidadoActual.findByRptDesde", query = "SELECT r FROM RptConsolidadoActual r WHERE r.rptDesde = :rptDesde")
    , @NamedQuery(name = "RptConsolidadoActual.findByRptHasta", query = "SELECT r FROM RptConsolidadoActual r WHERE r.rptHasta = :rptHasta")
    , @NamedQuery(name = "RptConsolidadoActual.findByFechaElaboracion", query = "SELECT r FROM RptConsolidadoActual r WHERE r.fechaElaboracion = :fechaElaboracion")
    , @NamedQuery(name = "RptConsolidadoActual.findByProyecto", query = "SELECT r FROM RptConsolidadoActual r WHERE r.proyecto = :proyecto")
    , @NamedQuery(name = "RptConsolidadoActual.findByRazonsocial", query = "SELECT r FROM RptConsolidadoActual r WHERE r.razonsocial = :razonsocial")
    , @NamedQuery(name = "RptConsolidadoActual.findByNombre", query = "SELECT r FROM RptConsolidadoActual r WHERE r.nombre = :nombre")
    , @NamedQuery(name = "RptConsolidadoActual.findByNumeroContratoObra", query = "SELECT r FROM RptConsolidadoActual r WHERE r.numeroContratoObra = :numeroContratoObra")
    , @NamedQuery(name = "RptConsolidadoActual.findByContObraValorInicial", query = "SELECT r FROM RptConsolidadoActual r WHERE r.contObraValorInicial = :contObraValorInicial")
    , @NamedQuery(name = "RptConsolidadoActual.findByContObraActaInicio", query = "SELECT r FROM RptConsolidadoActual r WHERE r.contObraActaInicio = :contObraActaInicio")
    , @NamedQuery(name = "RptConsolidadoActual.findByContObraPlazoInicial", query = "SELECT r FROM RptConsolidadoActual r WHERE r.contObraPlazoInicial = :contObraPlazoInicial")
    , @NamedQuery(name = "RptConsolidadoActual.findByContObraFechaTermi", query = "SELECT r FROM RptConsolidadoActual r WHERE r.contObraFechaTermi = :contObraFechaTermi")
    , @NamedQuery(name = "RptConsolidadoActual.findByPresentoFactura", query = "SELECT r FROM RptConsolidadoActual r WHERE r.presentoFactura = :presentoFactura")
    , @NamedQuery(name = "RptConsolidadoActual.findByFechaUltimaFactura", query = "SELECT r FROM RptConsolidadoActual r WHERE r.fechaUltimaFactura = :fechaUltimaFactura")
    , @NamedQuery(name = "RptConsolidadoActual.findByValorUltimaFactura", query = "SELECT r FROM RptConsolidadoActual r WHERE r.valorUltimaFactura = :valorUltimaFactura")
    , @NamedQuery(name = "RptConsolidadoActual.findByBasicoObra", query = "SELECT r FROM RptConsolidadoActual r WHERE r.basicoObra = :basicoObra")
    , @NamedQuery(name = "RptConsolidadoActual.findByProgramadoAcumulado", query = "SELECT r FROM RptConsolidadoActual r WHERE r.programadoAcumulado = :programadoAcumulado")
    , @NamedQuery(name = "RptConsolidadoActual.findByEjecutadoAcumulado", query = "SELECT r FROM RptConsolidadoActual r WHERE r.ejecutadoAcumulado = :ejecutadoAcumulado")
    , @NamedQuery(name = "RptConsolidadoActual.findBySiifValor", query = "SELECT r FROM RptConsolidadoActual r WHERE r.siifValor = :siifValor")
    , @NamedQuery(name = "RptConsolidadoActual.findBySiifFecha", query = "SELECT r FROM RptConsolidadoActual r WHERE r.siifFecha = :siifFecha")
    , @NamedQuery(name = "RptConsolidadoActual.findByTotalInversionEjecutada", query = "SELECT r FROM RptConsolidadoActual r WHERE r.totalInversionEjecutada = :totalInversionEjecutada")
    , @NamedQuery(name = "RptConsolidadoActual.findByValorVigencia", query = "SELECT r FROM RptConsolidadoActual r WHERE r.valorVigencia = :valorVigencia")
    , @NamedQuery(name = "RptConsolidadoActual.findByVigenciaProgramada", query = "SELECT r FROM RptConsolidadoActual r WHERE r.vigenciaProgramada = :vigenciaProgramada")
    , @NamedQuery(name = "RptConsolidadoActual.findByAvanceObraFisica", query = "SELECT r FROM RptConsolidadoActual r WHERE r.avanceObraFisica = :avanceObraFisica")
    , @NamedQuery(name = "RptConsolidadoActual.findByEstado", query = "SELECT r FROM RptConsolidadoActual r WHERE r.estado = :estado")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct5Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act5Prg = :act5Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct5Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act5Avc = :act5Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct1Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act1Prg = :act1Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct1Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act1Avc = :act1Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct2Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act2Prg = :act2Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct2Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act2Avc = :act2Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct3Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act3Prg = :act3Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct3Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act3Avc = :act3Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct4Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act4Prg = :act4Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct4Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act4Avc = :act4Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct6Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act6Prg = :act6Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct6Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act6Avc = :act6Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct7Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act7Prg = :act7Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct7Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act7Avc = :act7Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct8Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act8Prg = :act8Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct8Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act8Avc = :act8Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct9Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act9Prg = :act9Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct9Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act9Avc = :act9Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct10Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act10Prg = :act10Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct10Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act10Avc = :act10Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct11Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act11Prg = :act11Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct11Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act11Avc = :act11Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct12Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act12Prg = :act12Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct12Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act12Avc = :act12Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct13Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act13Prg = :act13Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct13Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act13Avc = :act13Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct14Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act14Prg = :act14Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct14Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act14Avc = :act14Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct15Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act15Prg = :act15Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct15Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act15Avc = :act15Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct16Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act16Prg = :act16Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct16Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act16Avc = :act16Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct17Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act17Prg = :act17Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct17Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act17Avc = :act17Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct18Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act18Prg = :act18Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct18Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act18Avc = :act18Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct19Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act19Prg = :act19Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct19Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act19Avc = :act19Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct20Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act20Prg = :act20Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct20Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act20Avc = :act20Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct21Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act21Prg = :act21Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct21Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act21Avc = :act21Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct22Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act22Prg = :act22Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct22Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act22Avc = :act22Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct23Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act23Prg = :act23Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct23Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act23Avc = :act23Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct24Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act24Prg = :act24Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct24Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act24Avc = :act24Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct25Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act25Prg = :act25Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct25Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act25Avc = :act25Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct26Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act26Prg = :act26Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct26Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act26Avc = :act26Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct27Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act27Prg = :act27Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct27Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act27Avc = :act27Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct28Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act28Prg = :act28Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct28Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act28Avc = :act28Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct29Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act29Prg = :act29Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct29Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act29Avc = :act29Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct30Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act30Prg = :act30Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct30Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act30Avc = :act30Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct31Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act31Prg = :act31Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct31Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act31Avc = :act31Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct32Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act32Prg = :act32Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct32Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act32Avc = :act32Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct33Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act33Prg = :act33Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct33Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act33Avc = :act33Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct34Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act34Prg = :act34Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct34Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act34Avc = :act34Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct35Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act35Prg = :act35Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct35Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act35Avc = :act35Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct36Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act36Prg = :act36Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct36Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act36Avc = :act36Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct37Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act37Prg = :act37Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct37Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act37Avc = :act37Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct38Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act38Prg = :act38Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct38Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act38Avc = :act38Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct39Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act39Prg = :act39Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct39Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act39Avc = :act39Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct40Prg", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act40Prg = :act40Prg")
    , @NamedQuery(name = "RptConsolidadoActual.findByAct40Avc", query = "SELECT r FROM RptConsolidadoActual r WHERE r.act40Avc = :act40Avc")
    , @NamedQuery(name = "RptConsolidadoActual.findByTempo", query = "SELECT r FROM RptConsolidadoActual r WHERE r.tempo = :tempo")})
public class RptConsolidadoActual implements Serializable {
    ...
    @Column(name = "RPT_DESDE")
    @Temporal(TemporalType.DATE)
    private Date rptDesde;
    @Column(name = "RPT_HASTA")
    @Temporal(TemporalType.DATE)
    private Date rptHasta;
    ...
    public RptConsolidadoActual() {
    }

    public RptConsolidadoActual(Integer identificador) {
        this.identificador = identificador;
    }

    public RptConsolidadoActual(Integer identificador, String proyecto, BigDecimal contObraValorInicial, BigDecimal contObraPlazoInicial, String presentoFactura) {
        this.identificador = identificador;
    ...
    public Date getRptDesde() {
        return rptDesde;
    }

    public void setRptDesde(Date rptDesde) {
        this.rptDesde = rptDesde;
    }

    public Date getRptHasta() {
        return rptHasta;
    }

    public void setRptHasta(Date rptHasta) {
        this.rptHasta = rptHasta;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RptConsolidadoActual)) {
            return false;
        }
        RptConsolidadoActual other = (RptConsolidadoActual) object;
    ...
    public String toString() {
        return "invias.cifra.entity.RptConsolidadoActual[ identificador=" + identificador + " ]";
    }
